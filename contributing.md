# Contributing to cordlr-clear

First and foremost, thank you! We appreciate that you want to contribute to cordlr-clear, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for cordlr-clear**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for cordlr-clear:

- star the [project](https://github.com/seanc/cordlr-clear)
- tweet your support for cordlr-clear
...
- **version**: please note the version of cordlr-clear are you using
...
[so]: http://stackoverflow.com/questions/tagged/cordlr-clear